...
from stage2_fundus_dataset import Stage2FundusDataset  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Extract retrieved evidence for EviScreen stage-2 head training.")
    ...
    parser.add_argument(
        "--splits",
        nargs="+",
        default=["fundus_remain_5000", "fundus_val", "JSIEC_original", "RIADD_original"],
...
def extract_split(
    ...
    expected_shape = (len(targets), 256, args.nn)
    ...
    LOGGER.info(
        "Saved %s retrieved data: images=%s normal_scores=%s pathological_scores=%s",
        split_name,
        len(targets),
